...
<body>
    ...
    $data_lang= file_get_contents($lang.'.json');
        ...
        $arr_json=json_decode($data_lang,true);
...
<div id="header" class="fixed-top">
	<div class="container">
		<div class="row">
            ...
            <div id="menu" class="col-lg-5 col-md-5 col-sm-12"><a href="index.php?style=style1">Style01</a> | <a href="index.php?style=style2">Style02</a> | <a href="index.php?style=style3">Style03</a> | <a href="index.php?style=style4">Style04</a></div>
